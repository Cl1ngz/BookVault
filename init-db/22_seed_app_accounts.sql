...
DO $$
DECLARE
    v_hash_admin     TEXT := '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy'; -- admin123
    v_hash_moderator TEXT := '$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGnyHidN6BC9j6cOW/SS'; -- moderator123
BEGIN
    -- Admins
    ...
    ON CONFLICT (email) DO NOTHING;
    RAISE NOTICE 'App accounts seeded: 2 admins, 5 moderators.';
END $$;
